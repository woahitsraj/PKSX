...
- [#257](https://github.com/woahitsraj/PKSX/issues/257) amends BOXES-2 so the Save File-wide Legality Report can explicitly preview and atomically apply supported Legality Fixes for Illegal Pokemon.
...
Source: [#177](https://github.com/woahitsraj/PKSX/issues/177), amended by [#210](https://github.com/woahitsraj/PKSX/issues/210) and [#257](https://github.com/woahitsraj/PKSX/issues/257). [#215](https://github.com/woahitsraj/PKSX/issues/215) and [#218](https://github.com/woahitsraj/PKSX/issues/218) own implementation, and [#256](https://github.com/woahitsraj/PKSX/issues/256) adds the Save File-wide Legality Report.
...
Unavailable entries remain visible and explain why without executing. Pokemon Storage disables Export, Save a backup, and Legality Report. The active Save File's pane disables Switch and Close and directs the user to select another active Save File from Saves. That restriction belongs to this Box Menu only and does not prevent choosing Pokemon Storage in Saves. Export writes Workspace bytes. Save a backup invokes the existing manual Backup behavior. Legality Report opens the Save File-wide Legality Report Takeover for that pane. The report is read-only until the user explicitly previews and applies supported Legality Fixes for Illegal Pokemon. Warning-grade results stay excluded. Apply uses one automatic Backup and one atomic Workspace commit after every selected fix succeeds.
...
| BOXES-1, BOXES-2           | [#159](https://github.com/woahitsraj/PKSX/issues/159), [#177](https://github.com/woahitsraj/PKSX/issues/177), [#201](https://github.com/woahitsraj/PKSX/issues/201), amended by [#210](https://github.com/woahitsraj/PKSX/issues/210) and [#257](https://github.com/woahitsraj/PKSX/issues/257); implementation [#215](https://github.com/woahitsraj/PKSX/issues/215), [#218](https://github.com/woahitsraj/PKSX/issues/218), and [#256](https://github.com/woahitsraj/PKSX/issues/256)                                                                                                                                                                                                                                |
