...
- The manual `Signed Android bootstrap bundle` workflow produces a short-lived GitHub artifact and can optionally upload it to internal testing without publishing a version tag.
